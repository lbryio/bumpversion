...
``[file]``
  **default: none** (optional)
  ...
  configuration file either, no files will be modified.
...
Development of this happens on GitHub; patches, tests, and documentation
...
*v0.4.1*; however, it deprecates two uses that will be removed in a future version.
